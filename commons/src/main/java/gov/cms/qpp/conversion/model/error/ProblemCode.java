...
public enum ProblemCode implements LocalizedProblem {
	...
	PCF_DENOMINATOR_COUNT_INVALID(101, "Denominator count must be equal to Initial Population count for `(Program name)` Plus measure population `(measure population id)`.", true),
