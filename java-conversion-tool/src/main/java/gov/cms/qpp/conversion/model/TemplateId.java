...
public enum TemplateId {
	QRDA_CATEGORY_III_REPORT_V3("2.16.840.1.113883.10.20.27.1.1", Extension.JUNE2017),
	CLINICAL_DOCUMENT("2.16.840.1.113883.10.20.27.1.2", Extension.JULY2017),
	ACI_AGGREGATE_COUNT("2.16.840.1.113883.10.20.27.3.3"),
	IA_SECTION("2.16.840.1.113883.10.20.27.2.4", Extension.JUNE2017),
	ACI_SECTION("2.16.840.1.113883.10.20.27.2.5", Extension.JUNE2017),
	MEASURE_PERFORMED("2.16.840.1.113883.10.20.27.3.27", Extension.SEPTEMBER2016),
	ACI_NUMERATOR_DENOMINATOR("2.16.840.1.113883.10.20.27.3.28", Extension.JUNE2017),
	ACI_NUMERATOR("2.16.840.1.113883.10.20.27.3.31", Extension.SEPTEMBER2016),
	ACI_DENOMINATOR("2.16.840.1.113883.10.20.27.3.32", Extension.SEPTEMBER2016),
	IA_MEASURE("2.16.840.1.113883.10.20.27.3.33", Extension.SEPTEMBER2016),
	REPORTING_PARAMETERS_ACT("2.16.840.1.113883.10.20.27.3.23", Extension.NOVEMBER2016),
	MEASURE_DATA_CMS_V2("2.16.840.1.113883.10.20.27.3.16", Extension.NOVEMBER2016),
	MEASURE_SECTION_V2("2.16.840.1.113883.10.20.27.2.3", Extension.NOVEMBER2016),
	REPORTING_PARAMETERS_SECTION("2.16.840.1.113883.10.20.27.2.6", Extension.NOVEMBER2016),
	MEASURE_REFERENCE_RESULTS_CMS_V2("2.16.840.1.113883.10.20.27.3.17", Extension.NOVEMBER2016),
	ACI_MEASURE_PERFORMED_REFERENCE_AND_RESULTS("2.16.840.1.113883.10.20.27.3.29", Extension.SEPTEMBER2016),

	//unimplemented
	CONTINUOUS_VARIABLE_MEASURE_VALUE_CMS("2.16.840.1.113883.10.20.27.3.26"),
	ETHNICITY_SUPPLEMENTAL_DATA_ELEMENT_CMS_V2("2.16.840.1.113883.10.20.27.3.22", Extension.NOVEMBER2016),
	REPORTING_STRATUM_CMS("2.16.840.1.113883.10.20.27.3.20"),
	SEX_SUPPLEMENTAL_DATA_ELEMENT_CMS_V2("2.16.840.1.113883.10.20.27.3.21", Extension.NOVEMBER2016),
	RACE_SUPPLEMENTAL_DATA_ELEMENT_CMS_V2("2.16.840.1.113883.10.20.27.3.19", Extension.NOVEMBER2016),
	PAYER_SUPPLEMENTAL_DATA_ELEMENT_CMS_V2("2.16.840.1.113883.10.20.27.3.18", Extension.NOVEMBER2016),
