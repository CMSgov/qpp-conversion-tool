...
//			List<Element> childElements = element.getChildren(childTag, defaultNs);
//			if (childElements == null) {
//				LOG.debug(childTag +" is null");
//				continue;
//			}
//			LOG.debug(childTag +" is found");
//			for (Element child : childElements) {
//				subNode = this.decode(child, new Node());
//				LOG.debug(childTag +" result node "+ subNode);
//				if (subNode != null) {
//					thisnode.addChildNode(subNode);
//		//			break;
//				}
//			}
//		}
