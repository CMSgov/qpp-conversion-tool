...
public class AciSectionEncoderTest {
	...
	public void testInternalEncode() {
		...
		AciSectionEncoder aciSectionEncoder = new AciSectionEncoder(ConverterTestHelper.newMockConverter());
	...
	public void internalEncodeNegativeWithNoReportingParameters() throws EncodeException {
		...
		AciSectionEncoder encoder = spy(new AciSectionEncoder(ConverterTestHelper.newMockConverter()));
		JsonWrapper jsonWrapper = new JsonWrapper();
