...
public class AciNumeratorDenominatorDecoderTest {
	...
	public void decodeAggregateCountAsNode() throws Exception {
		...
		Node aggregateCountNode = new QppXmlDecoder(ConverterTestHelper.newMockConverter()).decode(XmlUtils.stringToDom(xmlFragment));
	...
	public void decodeAciNumeratorDenominatorNullValueAsNode() throws Exception {
		...
		Node numDenomNode = new QppXmlDecoder(ConverterTestHelper.newMockConverter()).decode(XmlUtils.stringToDom(xmlFragment));
	...
	public void decodeValidAciNumeratorDenominatorTest() throws XmlException {
		Node aciMeasureNode = new QppXmlDecoder(ConverterTestHelper.newMockConverter()).decode(XmlUtils.stringToDom(getValidXmlFragment()));
	...
	public void decodeAciNumeratorDenominatorExtraneousXMLTest() throws XmlException {
		...
		Node aciMeasureNode = new QppXmlDecoder(ConverterTestHelper.newMockConverter()).decode(XmlUtils.stringToDom(xmlFragment));
		assertThat("Decoded xml fragment should contain one child node",
	...
	public void testInternalDecode() throws Exception {
		...
		AciNumeratorDenominatorDecoder objectUnderTest = new AciNumeratorDenominatorDecoder(ConverterTestHelper.newMockConverter());
