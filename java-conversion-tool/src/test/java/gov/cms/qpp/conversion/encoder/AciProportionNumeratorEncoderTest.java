...
public class AciProportionNumeratorEncoderTest {
	...
	public void createNode() {
		...
		numeratorDenominatorValueNode.setId("observation", "2.16.840.1.113883.10.20.27.3.3");
		numeratorDenominatorValueNode.add("aciNumeratorDenominator", "600");

		aciProportionNumeratorNode = new Node();
		aciProportionNumeratorNode.setId("observation", "2.16.840.1.113883.10.20.27.3.31");
