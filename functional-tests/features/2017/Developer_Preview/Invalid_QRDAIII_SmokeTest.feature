@tcID_261947
@testRail @qppct_devprev @CI @ConverterEndpoint
Feature: C261947 This is a test that verifies a QRDA-III files with a fake program name receive the proper error code and message.
  ...
  Scenario Outline: Negative
    ...
    And   the JSON response at "errors/0/details/0/message" should be "CT - The Clinical Document program name pqrs_mips_indiv is not recognized. Valid program names are MIPS_VIRTUALGROUP, MIPS_GROUP, CPCPLUS, or MIPS_INDIV."
