...
Feature: C261933 This is a test that verifies QRDA-III MIPS and CPC+ files with no program code receive the proper error code and message.
  ...
  Scenario Outline: Negative
    ...
    And   the JSON response at "errors/0/details/0/message" should be "CT - The Clinical Document program name  is not recognized. Valid program names are MIPS_VIRTUALGROUP, MIPS_GROUP, CPCPLUS, or MIPS_INDIV."
