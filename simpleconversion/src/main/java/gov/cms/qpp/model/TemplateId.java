...
public enum TemplateId {
	...
	MEASURE_PERFORMED("2.16.840.1.113883.10.20.27.3.27", "2016-09-01"),
	ACI_NUMERATOR_DENOMINATOR("2.16.840.1.113883.10.20.27.3.28", "2016-09-01"),
	...
	SEX_SUPPLEMENTAL_DATA_ELEMENT_CMS_V2("2.16.840.1.113883.10.20.27.3.21", "2016-11-01"),
	...
	public static TemplateId getTypeById(final String root, final String extension) {
		for (TemplateId currentTemplateId : TemplateId.values()) {
			if (currentTemplateId.getRoot().equals(root) &&
					(currentTemplateId.getExtension().isEmpty() || currentTemplateId.getExtension().equals(extension))) {
