...
public class MeasureConfigHelper {
	...
	protected static Set<String> MULTI_TO_SINGLE_PERF_RATE_MEASURE_ID = ImmutableSet.of("005", "008", "143", "438");
	protected static String SINGLE_TO_MULTI_PERF_RATE_MEASURE_ID = "370";
