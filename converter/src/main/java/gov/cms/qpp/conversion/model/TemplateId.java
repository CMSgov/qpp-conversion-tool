...
public enum TemplateId {
	...
	IA_MEASURE("2.16.840.1.113883.3.249.20.3.1", Extension.MAY_2018, "Improvement Activity"),
	REPORTING_PARAMETERS_ACT("2.16.840.1.113883.10.20.17.3.8"),
	MEASURE_DATA_CMS_V2("2.16.840.1.113883.10.20.27.3.16", Extension.MAY_2018),
	PERFORMANCE_RATE_PROPORTION_MEASURE("2.16.840.1.113883.10.20.27.3.25", Extension.MAY_2018),
	MEASURE_SECTION_V3("2.16.840.1.113883.10.20.27.2.3", Extension.JULY_2017, "Measure Section"),
	MEASURE_REFERENCE_RESULTS_CMS_V4("2.16.840.1.113883.10.20.27.3.17", Extension.MAY_2019, "Quality Measure"),
	...
	MEASURE_SECTION_V4("2.16.840.1.113883.10.20.27.2.1", Extension.JUNE_2017),
