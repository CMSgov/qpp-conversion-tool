...
public enum TemplateId {
	...
	ACI_SECTION("2.16.840.1.113883.10.20.27.2.5", Extension.JUNE_2017, "PI Section"),
	MEASURE_PERFORMED("2.16.840.1.113883.10.20.27.3.27", Extension.SEPTEMBER_2016),
	ACI_NUMERATOR_DENOMINATOR("2.16.840.1.113883.10.20.27.3.28", Extension.JUNE_2017, "PI Measure"),
