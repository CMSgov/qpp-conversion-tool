...
public class PcfMeasureDataValidator extends NodeValidator {
	...
	private void validateSupplementalDataByType(Node node) {
		Map<SupplementalData.SupplementalType, TemplateId> nodeTypeToTemplateIdMap =
			SupplementalData.getSupplementalTypeMapToTemplateId();
		for (Map.Entry<SupplementalData.SupplementalType, TemplateId> entry: nodeTypeToTemplateIdMap.entrySet()) {
	...
	private void validateAllSupplementalNodesOfSpecifiedType(
		Node node, TemplateId currSupplementalDataTemplateId, SupplementalData.SupplementalType supplementalDataType) {
