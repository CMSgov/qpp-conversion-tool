 ...
 */
@Validator(TemplateId.MEASURE_SECTION_V6)
public class QualityMeasureSectionValidator extends NodeValidator {
	...
	protected void performValidation(Node node) {
		checkErrors(node)
			...
			.childMinimum(ProblemCode.MEASURE_SECTION_MISSING_MEASURE, 1, TemplateId.MEASURE_REFERENCE_RESULTS_CMS_V6)
		    .oneChildPolicy(ProblemCode.MEASURES_RNR_WITH_DUPLICATED_MEASURE_GUID, TemplateId.MEASURE_REFERENCE_RESULTS_CMS_V6,
					childNode -> childNode.getValue(MEASURE_ID))
			.singleValue(ProblemCode.MEASURE_SECTION_V6_REQUIRES_CATEGORY_SECTION, CATEGORY_SECTION_V5)
			.valueIs(ProblemCode.MEASURE_SECTION_V6_REQUIRES_CATEGORY_SECTION, CATEGORY_SECTION_V5,
