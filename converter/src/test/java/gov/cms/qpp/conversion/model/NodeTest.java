...
class NodeTest {
	...
	void testChild() {
		...
		childNode.setType(TemplateId.PI_SECTION_V3);
	...
	void testFindParentNodeWithHumanReadableTemplateIdTraverse() {
		...
		Node middleLevelNode = new Node(TemplateId.PI_SECTION_V3, topLevelNode);
	...
	void testEquals() {
		...
		Node child1 = new Node(TemplateId.IA_SECTION_V3);
		child1.setParent(parent);
		Node child2 = new Node(TemplateId.PI_SECTION_V3);
